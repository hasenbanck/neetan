...
impl Default for I286Flags {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I286Flags {
    fn eq(&self, other: &Self) -> bool {
        self.compress() == other.compress()
    }
}

impl Eq for I286Flags {}
