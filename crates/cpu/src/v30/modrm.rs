        ...
        match mode {
            0 => match rm {
                0 => {
                    ...
                    self.ea =
                        self.default_base(SegReg16::DS).wrapping_add(self.eo as u32) & 0xFFFFF;
                }
                1 => {
                    self.eo = self
                        .regs
                ...
                2 => {
                    self.eo = self
                        ...
                        .wrapping_add(self.regs.word(WordReg::SI));
                    self.ea =
                        self.default_base(SegReg16::SS).wrapping_add(self.eo as u32) & 0xFFFFF;
                }
                3 => {
                    self.eo = self
                        .regs
            ...
            1 => {
                ...
                self.ea = self.default_base(seg).wrapping_add(self.eo as u32) & 0xFFFFF;
            }
            2 => {
