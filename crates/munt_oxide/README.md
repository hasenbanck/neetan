# Rust port of mt32emu

munt_oxide is a port of the [mt32emu library](https://github.com/munt/munt/tree/master/mt32emu) of the Munt project,
which allows to emulate (approximately) [the Roland MT-32, CM-32L and LAPC-I synthesiser modules](https://en.wikipedia.org/wiki/Roland_MT-32).
